...
class SaleUIBackup extends ConsumerStatefulWidget {
  SaleUIBackup({Key? key, required this.allMemo}) : super(key: key);
  static const routeName = "/sale_ui";

  AllMemoInformationModel allMemo;

  @override
  ConsumerState<SaleUIBackup> createState() => _SaleUIState();
}

class _SaleUIState extends ConsumerState<SaleUIBackup> {
    ...
    return Consumer(builder: (context, ref, _) {
      ...
      return Container(
        ...
        decoration: BoxDecoration(
            ...
            gradient: const LinearGradient(begin: Alignment.topLeft, end: Alignment.bottomRight, stops: [0.5, 1], colors: [primary, red3])),

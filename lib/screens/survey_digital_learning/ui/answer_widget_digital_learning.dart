...
class AnswerWidgetDigitalLearning extends StatefulWidget {
  final QuestionModel questionModel;

  const AnswerWidgetDigitalLearning({
    Key? key,
    required this.questionModel,
  }) : super(key: key);

  @override
  _AnswerWidgetDigitalLearningState createState() => _AnswerWidgetDigitalLearningState();
}

class _AnswerWidgetDigitalLearningState extends State<AnswerWidgetDigitalLearning> {
                ...
                child: Padding(
                  ...
                  child: widget.questionModel.selectedAnswers.isEmpty
                                      ...
                                      ImageService()
                                        ...
                                        if (compressedImage != null) {
                                          if (await ConnectivityService().checkInternet()) {
                                            ...
                                            bool done = await ImageService().sendImage(compressedImage.path, "surveyImage/${widget.questionModel.id}/${date.year}/${date.month}/${date.day}/surveyImage"
                                                ".jpeg"); //TODO
                                            if (done) {
                                        ...
                                        setState(() {
                                          widget.questionModel.selectedAnswers = ['survey if .jpeg']; //TODO
                      ...
                      Row(
                          ...
                          children: [
                            Image.file(File(widget.questionModel.image??'')),
                            IconButton(
                              icon: const Icon(

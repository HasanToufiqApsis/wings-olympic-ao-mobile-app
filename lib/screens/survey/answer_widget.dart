                                      ...
                                      ImageService()
                                        ...
                                        if (compressedImage != null) {
                                          if (await ConnectivityService().checkInternet()) {
                                            ...
                                            bool done = await ImageService().sendImage(compressedImage.path, "surveyImage/${widget.questionModel.id}/${date.year}/${date.month}/${date.day}/${widget.retailer.deplId}/${widget.retailer.sectionId}/${widget.retailer.outletCode}/${widget.retailer.outletCode}.jpeg");
                                            if (done) {
                                        ...
                                        setState(() {
                                          widget.questionModel.selectedAnswers = ['${widget.retailer.outletCode}.jpeg'];
